...
function App() {
  ...
  return (
    ...
    <VStack minH={'100vh'} alignItems={'center'} justifyContent={'center'} bgColor='transparent'>
      <Heading display={'block'} fontSize={'3xl'} fontWeight={600} padding={6} paddingBottom={2}>Thailand Covid Cases</Heading>
